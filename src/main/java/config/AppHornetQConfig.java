...
@Configuration
@EnableJms
@ComponentScan("util.hornetq")
public class AppHornetQConfig {

    @Bean
    HornetQQueue hornetQQueue() {
        return new HornetQQueue("alex");
    }
    ...
    ConnectionFactory connectionFactory() {
        ...
        return new HornetQJMSConnectionFactory(false, new TransportConfiguration(NettyConnectorFactory.class.getName(), connDetails));
    }
    ...
    JmsTemplate jmsTemplate() {
        ...
        jmsTemplate.setDefaultDestination(hornetQQueue());
        return jmsTemplate;
    }
}
